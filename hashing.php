...
<td>hash</td>
				...
				<div class="col-md-3">
				     <div class="card card-primary card-outline">
				        ...
				        <div class="card-body">
						Generating hash values serves the purpose of data retrieval or ensuring security. A hash value, also known as a message digest, is a numerical representation derived from a sequence of text. The hash is considerably smaller than the original text and is created using a specific algorithm to minimize the chances of different text producing the same hash value.	
                        </div>
				     </div>
                     <div class="card card-primary card-outline">
						<div class="card-header">
				        ...
				        <div class="card-body">
				            Hashing can be used for many purposes:
                                <ul>
                                    <li>
                                   This tool enables the comparison of vast quantities of data. You generate unique hashes for the data, store these hashes, and later, when you wish to compare the data, you simply compare the hashes.
                                    </li>
                                    <li>
                                    Hashes are a useful tool for organizing and accessing data. In hash tables, they serve as pointers to the appropriate row. To locate a specific record efficiently, you can calculate the hash of the data and directly access the record indicated by the corresponding hash. This method assumes that you have a sorted list of hashes that accurately point to the desired records.
                                    ...
                                    <li>
                                    Hashing can be used to generate  random strings.
                                    </li>
                                </ul>		
                        </div>
				     </div>
