...
<head>
    ...
    <meta name="author" content="Tumenta">
	<meta name="generator" content="DeaconAi Watcher" />
...
?>" class="nav-link" target="_blank" data-toggle="tooltip" title="Visit Site" data-toggle="tooltip" data-placement="bottom">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<center><a href="dashboard.php" class="brand-link">
      <span class="brand-text font-weight-light">DeaconAi Watcher</span>
    </a></center>
	
	<div class="sidebar">
	
      <div class="user-panel mt-3 d-flex align-content-center justify-content-center flex-wrap">
          <p class="margin_auto"><a href="account.php" class="btn btn-sm btn-secondary btn-flat"><i class="fas fa-user fa-fw"></i> Mon Hesap</a>
		  &nbsp;&nbsp;<a href="logout.php" class="btn btn-sm btn-danger btn-flat"><i class="fas fa-sign-out-alt fa-fw"></i> Çik Out </a></p>
      </div>
...
?>">
              <i class="fas fa-home"></i>&nbsp; <p>See All</p>
           </a>
        </li>
...
?>">
              <i class="fas fa-info-circle"></i>&nbsp; <p>Watcher's Bilgi </p>
           </a>
        </li>
...
?>">
              <i class="fas fa-flag"></i>&nbsp; <p>Clearances<i class="fas fa-angle-right right"></i>
           </p></a>
...
?>"><i class="fas fa-user"></i>&nbsp; <p>I.P Clearances</p></a></li>
               <li class="nav-item <?php
...
?>"><i class="far fa-file-alt"></i>&nbsp; <p>File Clearances</p></a></li>
           </ul>
        </li>
...
?>">
              <i class="fas fa-history"></i>&nbsp; <p>Tum Loginleri </p>
           </a>
        </li>

        <li class="nav-header">Orion II Security</li>
...
?>">
              <i class="fas fa-code"></i>&nbsp; <p>Anti-SQL Injection
<?php
...
?>">
              <i class="fas fa-user-secret"></i>&nbsp; <p>Bad Bots Executor
<?php
...
?>">
              <i class="fas fa-globe"></i>&nbsp; <p>Anti VPN/Proxy
<?php
...
?>">
              <i class="fas fa-keyboard"></i>&nbsp; <p>Auto Spam Killer
<?php
...
?>">
              <i class="fas fa-align-justify"></i>&nbsp; <p> Red-Alerts  <i class="fas fa-angle-right right"></i>
           </p></a>
           <ul class="nav nav-treeview">
               <li class="nav-item <?php
...
?>"><i class="fas fa-align-justify"></i>&nbsp; <p>All Red Alerts <span class="badge right badge-primary"><?php
    echo $lcount1;
?></span></p></a></li>
               <li class="nav-item <?php
...
?>"><i class="fas fa-code"></i>&nbsp; <p>SQLi Injections <span class="badge right badge-info"><?php
    echo $lcount2;
?></span></p></a></li>
               <li class="nav-item <?php
...
?>"><i class="fas fa-robot"></i>&nbsp; <p>killed Bots <span class="badge right badge-danger"><?php
    echo $lcount3;
?></span></p></a></li>
               <li class="nav-item <?php
...
?>"><i class="fas fa-keyboard"></i>&nbsp; <p>SPAM Detect <span class="badge right badge-warning"><?php
    echo $lcount5;
?></span></p></a></li>
           </ul>
        </li>
...
?>
		...
		<li class="nav-header">Server Folders Security Check</li>
...
?>">
		...
		<li class="nav-header">DEACON ANALYTICS &nbsp;
<?php
...
?>">
              <i class="fas fa-globe"></i>&nbsp; <p>Your Site's Live Traffic</p>
           </a>
        </li>
...
?>">
              <i class="fas fa-chart-line"></i>&nbsp; <p>Your Site's Past Visit Analytics</p>
           </a>
        </li>
          
        <li class="nav-header">Encryption/CryptoGraphy</li>
...
?>">
              <i class="fas fa-exclamation-circle"></i>&nbsp; <p>HATA Error Monitoring</p>
           </a>
        </li>
...
?>">
              <i class="fas fa-columns"></i>&nbsp; <p>Edit Your .htacces</p>
           </a>
        </li>
...
?>">
              <i class="fas fa-search"></i>&nbsp; <p>Fake Accounts Hunters </p>
           </a>
        </li>
...
?>">
              <i class="fas fa-lock"></i>&nbsp; <p>BlockChain Hashing</p>
           </a>
        </li>
...
<footer class="main-footer">
    ...
    <strong>&copy; <?php
    echo date("Y");
?> <a href="www.deaconai.io" target="_blank">DeaconAi Watcher</a> v2.1</strong>
